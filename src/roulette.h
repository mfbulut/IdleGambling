...
// extern long long playerBet;
// extern Font font36;
// extern Sound spinSoundRoulette;
// extern Sound ballClickSound;
// extern Sound winSoundRoulette;
// extern Sound loseSoundRoulette;
// extern bool Blue_Button(Rectangle bounds, const char *text, Color baseColor);
// extern const char *FormatMoney(long long amount);
// extern void DrawTextCentered(Font font, const char* text, Rectangle bounds, float fontSize, Color tint);
        ...
        case ROULETTE_STATE_BETTING:
            {
                ...
                if (IsMouseButtonPressed(MOUSE_LEFT_BUTTON) && distFromCenter <= ROULETTE_WHEEL_RADIUS * 1.05f) {
                        ...
                        !CheckCollisionPointRec(mousePos, redButtonRect))
                    {
                         ...
                         rouletteSpeed = 0; // Stop any coasting immediately
